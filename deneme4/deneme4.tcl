...
#
# deneme4.tcl: Tcl script for re-creating project 'deneme4'
#
# Generated by Vivado on Thu Jan 08 14:58:21 +0300 2026
...
#
# 1. This project restoration tcl script (deneme4.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/axis_scaler.v"
#    "D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/dac_controller.v"
#    "D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/packet_parser.v"
#    "D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/spi_master_ad5791.v"
#    "D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/uartrx.v"
#    "D:/dds_project_all/deneme4/deneme4.srcs/constrs_1/new/Final.xdc"
#    "D:/dds_project_all/deneme4/deneme4.srcs/sim_1/new/tb_system_sim.v"
#    "D:/dds_project_all/deneme4/deneme4.srcs/utils_1/imports/synth_1/dac_controller.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/sources_1/new/axis_scaler.v"]"\
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/sources_1/new/dac_controller.v"]"\
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/sources_1/new/packet_parser.v"]"\
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/sources_1/new/spi_master_ad5791.v"]"\
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/sources_1/new/uartrx.v"]"\
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/constrs_1/new/Final.xdc"]"\
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/sim_1/new/tb_system_sim.v"]"\
 "[file normalize "$origin_dir/deneme4/deneme4.srcs/utils_1/imports/synth_1/dac_controller.dcp"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/deneme4"]"
...
set file "new/spi_master_ad5791.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "[file normalize "$origin_dir/deneme4/deneme4.srcs/constrs_1/new/Final.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/Final.xdc"
...
set_property -name "top" -value "tb_system_sim" -objects $obj
...
set file "synth_1/dac_controller.dcp"
...
if { [get_files [list axis_scaler.v]] == "" } {
  import_files -quiet -fileset sources_1 D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/axis_scaler.v
}
if { [get_files [list dac_controller.v]] == "" } {
  import_files -quiet -fileset sources_1 D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/dac_controller.v
}
if { [get_files [list packet_parser.v]] == "" } {
  import_files -quiet -fileset sources_1 D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/packet_parser.v
}
if { [get_files [list spi_master_ad5791.v]] == "" } {
  import_files -quiet -fileset sources_1 D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/spi_master_ad5791.v
}
if { [get_files [list uartrx.v]] == "" } {
  import_files -quiet -fileset sources_1 D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/uartrx.v
}
if { [get_files [list axis_scaler.v]] == "" } {
  import_files -quiet -fileset sources_1 D:/dds_project_all/deneme4/deneme4.srcs/sources_1/new/axis_scaler.v
}
...
# module references:
# axis_scaler, dac_controller, packet_parser, spi_master_ad5791, uartrx, axis_scaler, dac_controller, spi_master_ad5791
  ...
  set sync_n_0 [ create_bd_port -dir O sync_n_0 ]
  set ldac_n_0 [ create_bd_port -dir O ldac_n_0 ]
  set clr_n_0 [ create_bd_port -dir O clr_n_0 ]
  ...
  set sdin_1 [ create_bd_port -dir O sdin_1 ]
  set sync_n_1 [ create_bd_port -dir O sync_n_1 ]
  set ldac_n_1 [ create_bd_port -dir O ldac_n_1 ]
  set clr_n_1 [ create_bd_port -dir O clr_n_1 ]
  ...
  # Create instance: axis_scaler_0, and set properties
  set block_name axis_scaler
  set block_cell_name axis_scaler_0
  if { [catch {set axis_scaler_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_scaler_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: dac_controller_0, and set properties
  set block_name dac_controller
  set block_cell_name dac_controller_0
  if { [catch {set dac_controller_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dac_controller_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: spi_master_ad5791_0, and set properties
  set block_name spi_master_ad5791
  set block_cell_name spi_master_ad5791_0
  if { [catch {set spi_master_ad5791_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $spi_master_ad5791_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: axis_scaler_1, and set properties
  set block_name axis_scaler
  set block_cell_name axis_scaler_1
  if { [catch {set axis_scaler_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $axis_scaler_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create instance: dac_controller_1, and set properties
  set block_name dac_controller
  set block_cell_name dac_controller_1
  if { [catch {set dac_controller_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $dac_controller_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: spi_master_ad5791_1, and set properties
  set block_name spi_master_ad5791
  set block_cell_name spi_master_ad5791_1
  if { [catch {set spi_master_ad5791_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $spi_master_ad5791_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create port connections
  connect_bd_net -net Net [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins dds_compiler_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins dds_compiler_1/aclk] [get_bd_pins spi_master_ad5791_0/aclk] [get_bd_pins spi_master_ad5791_1/aclk] [get_bd_pins packet_parser_0/clk] [get_bd_pins axis_scaler_0/aclk] [get_bd_pins axis_scaler_1/aclk] [get_bd_pins uartrx_0/clk] [get_bd_pins dac_controller_0/clk] [get_bd_pins dac_controller_1/clk]
  connect_bd_net -net axis_data_fifo_0_m_axis_tdata [get_bd_pins axis_data_fifo_0/m_axis_tdata] [get_bd_pins dac_controller_0/s_axis_tdata]
  connect_bd_net -net axis_data_fifo_0_m_axis_tvalid [get_bd_pins axis_data_fifo_0/m_axis_tvalid] [get_bd_pins dac_controller_0/s_axis_tvalid]
  connect_bd_net -net axis_data_fifo_0_s_axis_tready [get_bd_pins axis_data_fifo_0/s_axis_tready] [get_bd_pins axis_scaler_0/m_axis_tready]
  connect_bd_net -net axis_data_fifo_1_m_axis_tdata [get_bd_pins axis_data_fifo_1/m_axis_tdata] [get_bd_pins dac_controller_1/s_axis_tdata]
  connect_bd_net -net axis_data_fifo_1_m_axis_tvalid [get_bd_pins axis_data_fifo_1/m_axis_tvalid] [get_bd_pins dac_controller_1/s_axis_tvalid]
  connect_bd_net -net axis_data_fifo_1_s_axis_tready [get_bd_pins axis_data_fifo_1/s_axis_tready] [get_bd_pins axis_scaler_1/m_axis_tready]
  connect_bd_net -net axis_scaler_0_m_axis_tdata [get_bd_pins axis_scaler_0/m_axis_tdata] [get_bd_pins axis_data_fifo_0/s_axis_tdata]
  connect_bd_net -net axis_scaler_0_m_axis_tvalid [get_bd_pins axis_scaler_0/m_axis_tvalid] [get_bd_pins axis_data_fifo_0/s_axis_tvalid]
  connect_bd_net -net axis_scaler_0_s_axis_tready [get_bd_pins axis_scaler_0/s_axis_tready] [get_bd_pins dds_compiler_0/m_axis_data_tready]
  connect_bd_net -net axis_scaler_1_m_axis_tdata [get_bd_pins axis_scaler_1/m_axis_tdata] [get_bd_pins axis_data_fifo_1/s_axis_tdata]
  connect_bd_net -net axis_scaler_1_m_axis_tvalid [get_bd_pins axis_scaler_1/m_axis_tvalid] [get_bd_pins axis_data_fifo_1/s_axis_tvalid]
  connect_bd_net -net axis_scaler_1_s_axis_tready [get_bd_pins axis_scaler_1/s_axis_tready] [get_bd_pins dds_compiler_1/m_axis_data_tready]
  connect_bd_net -net clk_in1_0_1 [get_bd_ports clk_in1_0] [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net dac_controller_0_m_axis_tdata [get_bd_pins dac_controller_0/m_axis_tdata] [get_bd_pins spi_master_ad5791_0/s_axis_tdata]
  connect_bd_net -net dac_controller_0_m_axis_tvalid [get_bd_pins dac_controller_0/m_axis_tvalid] [get_bd_pins spi_master_ad5791_0/s_axis_tvalid]
  connect_bd_net -net dac_controller_0_s_axis_tready [get_bd_pins dac_controller_0/s_axis_tready] [get_bd_pins axis_data_fifo_0/m_axis_tready]
  connect_bd_net -net dac_controller_1_m_axis_tdata [get_bd_pins dac_controller_1/m_axis_tdata] [get_bd_pins spi_master_ad5791_1/s_axis_tdata]
  connect_bd_net -net dac_controller_1_m_axis_tvalid [get_bd_pins dac_controller_1/m_axis_tvalid] [get_bd_pins spi_master_ad5791_1/s_axis_tvalid]
  connect_bd_net -net dac_controller_1_s_axis_tready [get_bd_pins dac_controller_1/s_axis_tready] [get_bd_pins axis_data_fifo_1/m_axis_tready]
  connect_bd_net -net dds_compiler_0_m_axis_data_tdata [get_bd_pins dds_compiler_0/m_axis_data_tdata] [get_bd_pins axis_scaler_0/s_axis_tdata]
  connect_bd_net -net dds_compiler_0_m_axis_data_tvalid [get_bd_pins dds_compiler_0/m_axis_data_tvalid] [get_bd_pins axis_scaler_0/s_axis_tvalid]
  connect_bd_net -net dds_compiler_1_m_axis_data_tdata [get_bd_pins dds_compiler_1/m_axis_data_tdata] [get_bd_pins axis_scaler_1/s_axis_tdata]
  connect_bd_net -net dds_compiler_1_m_axis_data_tvalid [get_bd_pins dds_compiler_1/m_axis_data_tvalid] [get_bd_pins axis_scaler_1/s_axis_tvalid]
  connect_bd_net -net packet_parser_0_m_axis_dds2_config_tdata [get_bd_pins packet_parser_0/m_axis_dds2_config_tdata] [get_bd_pins dds_compiler_1/s_axis_phase_tdata]
  connect_bd_net -net packet_parser_0_m_axis_dds2_config_tvalid [get_bd_pins packet_parser_0/m_axis_dds2_config_tvalid] [get_bd_pins dds_compiler_1/s_axis_phase_tvalid]
  connect_bd_net -net packet_parser_0_m_axis_dds_config_tdata [get_bd_pins packet_parser_0/m_axis_dds1_config_tdata] [get_bd_pins dds_compiler_0/s_axis_phase_tdata]
  connect_bd_net -net packet_parser_0_m_axis_dds_config_tvalid [get_bd_pins packet_parser_0/m_axis_dds1_config_tvalid] [get_bd_pins dds_compiler_0/s_axis_phase_tvalid]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins dds_compiler_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins dds_compiler_1/aresetn] [get_bd_pins spi_master_ad5791_0/aresetn] [get_bd_pins spi_master_ad5791_1/aresetn] [get_bd_pins packet_parser_0/reset] [get_bd_pins axis_scaler_0/aresetn] [get_bd_pins axis_scaler_1/aresetn] [get_bd_pins uartrx_0/rst_n] [get_bd_pins dac_controller_0/rst_n] [get_bd_pins dac_controller_1/rst_n]
  ...
  connect_bd_net -net spi_master_ad5791_0_clr_n [get_bd_pins spi_master_ad5791_0/clr_n] [get_bd_ports clr_n_0]
  connect_bd_net -net spi_master_ad5791_0_ldac_n [get_bd_pins spi_master_ad5791_0/ldac_n] [get_bd_ports ldac_n_0]
  connect_bd_net -net spi_master_ad5791_0_s_axis_tready [get_bd_pins spi_master_ad5791_0/s_axis_tready] [get_bd_pins dac_controller_0/m_axis_tready]
  connect_bd_net -net spi_master_ad5791_0_sclk [get_bd_pins spi_master_ad5791_0/sclk] [get_bd_ports sclk_0]
  connect_bd_net -net spi_master_ad5791_0_sdin [get_bd_pins spi_master_ad5791_0/sdin] [get_bd_ports sdin_0]
  connect_bd_net -net spi_master_ad5791_0_sync_n [get_bd_pins spi_master_ad5791_0/sync_n] [get_bd_ports sync_n_0]
  connect_bd_net -net spi_master_ad5791_1_clr_n [get_bd_pins spi_master_ad5791_1/clr_n] [get_bd_ports clr_n_1]
  connect_bd_net -net spi_master_ad5791_1_ldac_n [get_bd_pins spi_master_ad5791_1/ldac_n] [get_bd_ports ldac_n_1]
  connect_bd_net -net spi_master_ad5791_1_s_axis_tready [get_bd_pins spi_master_ad5791_1/s_axis_tready] [get_bd_pins dac_controller_1/m_axis_tready]
  connect_bd_net -net spi_master_ad5791_1_sclk [get_bd_pins spi_master_ad5791_1/sclk] [get_bd_ports sclk_1]
  connect_bd_net -net spi_master_ad5791_1_sdin [get_bd_pins spi_master_ad5791_1/sdin] [get_bd_ports sdin_1]
  connect_bd_net -net spi_master_ad5791_1_sync_n [get_bd_pins spi_master_ad5791_1/sync_n] [get_bd_ports sync_n_1]
  connect_bd_net -net uartrx_0_data_out [get_bd_pins uartrx_0/data_out] [get_bd_pins packet_parser_0/rx_data]
  connect_bd_net -net uartrx_0_valid [get_bd_pins uartrx_0/valid] [get_bd_pins packet_parser_0/rx_valid]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/deneme4/deneme4.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/deneme4.srcs/utils_1/imports/synth_1/dac_controller.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/deneme4.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/deneme4.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/deneme4.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
